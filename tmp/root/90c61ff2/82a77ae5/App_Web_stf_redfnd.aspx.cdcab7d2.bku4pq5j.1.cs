...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_stf_redfnd_aspx_cdcab7d2_bku4pq5j {
        ...
        private FastObjectFactory_app_web_stf_redfnd_aspx_cdcab7d2_bku4pq5j() {
        }
        
        static object Create_ASP_stf_redfnd_aspx() {
            return new ASP.stf_redfnd_aspx();
        }
    }
}
