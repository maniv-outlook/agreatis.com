#pragma checksum "C:\Inetpub\vhosts\agreatis.com\httpdocs\adminjob.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "04C63547337710F9A1E8CE7750C0C142C37D7361"

#line 1 "C:\Inetpub\vhosts\agreatis.com\httpdocs\adminjob.aspx.cs"
using System;
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack && id != 0)
        {
                ...
                })
                {
                    ...
                    using (SqlDataReader _read = _command.ExecuteReader())
                    {
                        while (_read.Read())
                        {
                            ...
                            checkShowPhone.Checked = _read.GetBoolean(19);
                            checkShowEmail.Checked = _read.GetBoolean(20);
                        }
                    }
                }
            }
            if (!Convert.ToBoolean(Request.Cookies["Admin"].Value) && (Convert.ToInt32(Request.Cookies["UserId"].Value) != _userId))
            {
                ...
                checkShowPhone.Enabled = false;
                checkShowEmail.Enabled = false;
        ...
        buttonRepost.Visible = false;
        checkShowPhone.Checked = true;
        checkShowEmail.Checked = true;
    }
    ...
    protected void buttonSubmit_Click(object sender, EventArgs e)
    {
        using (SqlConnection _con = new SqlConnection(ConfigurationManager.AppSettings["ConnStr"]))
        {
            ...
            })
            {
                ...
                _command.Parameters.AddWithValue("@ShowPhone", checkShowPhone.Checked);
                _command.Parameters.AddWithValue("@ShowEmail", checkShowEmail.Checked);
                _con.Open();
            ...
            if (textShort.Text == "")
            {
                const string key = "AIzaSyBbEgiPdnb-_MSn0FOJp3KvStvCHJz7OSk";
