...
<form id="form1" runat="server">
	<table border="0" cellpadding="2" cellspacing="2" width="100%">
		<tr>
			<td>
				<div align="center">
					<img alt="Pivotal Partners" height="125" src="images/logo_form.jpg" width="293" /></div>
			</td>
		</tr>
	</table>
	<h1>Applicant Voluntary Self-Disclosure Submittal Form</h1>
	The employers we represent are subject to certain governmental recordkeeping 
	and reporting requirements for the administration of civil rights laws and regulations. 
	In order to comply with these laws, we invite the applicant to voluntarily self-identify 
	their race/ethnicity, sex and veteran status.&nbsp;&nbsp; Submission of the 
	self identification information is voluntary and refusal to provide it will 
	not subject you to any adverse treatment or influence in the hiring process. 
	The information obtained will be kept confidential and may only be used in accordance 
	...
	government for civil rights enforcement. When reported, data will not identify
	<br />
	<br />
	<table border="0" cellpadding="5" cellspacing="5" width="100%">
		<tr>
			...
			<td>
				<asp:TextBox id="textID" runat="server" MaxLength="10"></asp:TextBox>
		...
		<tr>
			...
			<td>
				<asp:TextBox id="textLast" runat="server" MaxLength="255"></asp:TextBox>
			...
			<td>
				<asp:TextBox id="texFirst" runat="server" MaxLength="255"></asp:TextBox>
				<asp:RequiredFieldValidator id="reqFirst" runat="server" ControlToValidate="texFirst" Display="None" ErrorMessage="First Name is required."></asp:RequiredFieldValidator>
			</td>
			<td>
				<asp:TextBox id="textInit" runat="server" MaxLength="10"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<td colspan="1" style="line-height: 100%">
			</td>
		...
		<tr>
			...
			<td>
				<asp:TextBox id="textPosition" runat="server" MaxLength="255"></asp:TextBox>
			...
			<td>
				<asp:TextBox id="textDate" runat="server" MaxLength="255"></asp:TextBox>
...
<asp:ListItem Text="United States of America"/>				</asp:DropDownList>
			</td>
		</tr>
		<tr>
			<td>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			<td colspan="3"><strong>Please mark on box that describes the race/ethnicity 
				category with which you primarily indetify:</strong><br />
				<br />
			</td>
		</tr>
		<tr>
			...
			<td style="width: 60%">A person of Mexican, Puerto Rican, Cuban, Central 
				or South American or other Spanish culture or origin, regardless 
				of ethnicity.A person of Mexican, Puerto Rican, Cuban, Central or 
				South American or other Spanish culture or origin, regardless of 
				ethnicity. A person of Mexican, Puerto Rican, Cuban, Central or 
				South American or other Spanish culture or origin, regardless of 
				ethnicity.<br />
				<br />
			</td>
		...
		<tr>
			...
			<td>A person having origins in any of the original peoples of Europe, 
		...
		<tr>
			...
			<td>A person having origins in any of the peoples of Hawaii, Indian 
				Subcontinent, including, for example, Cambodia, China, India, Japan, 
				Korea, Malaysia, Pakistan, the Phillippine Islands, Thailand and 
				Vietnam. <br />
				<br />
			</td>
		</tr>
		<tr>
			...
			<td>A person having origins in any of the original peoples of North 
		...
		<tr>
			<td colspan="3"><hr />
				<h3>VETERAN STATUS – please check all that apply:</h3>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>(A) A veteran who is entitled to compensation (or who, but for receipt 
				of military retired pay, would be entitled to compensation) under 
				laws administered by the Dept. of Veteran Affairs for a disability 
				rated at 10 or 20% in the case of a veteran who has been determined 
				to have a serious employment disability OR <br />
				<br />
				(B) A person who was discharged or released from active duty because 
				of a service-connected disability <br />
				<br />
			</td>
		</tr>
		<tr>
			...
			<td>A person who:<br />
				<br />
				(A) Served on active duty for a period of time more than 180 days, 
				any part of which occurred between 8/10/64 and 5/07/75 and was discharged 
				or released with other than a dishonorable discharge OR <br />
				<br />
				(B) Was discharged or released from active duty for a service connected 
				disability if any part of such active duty was performed between 
				8/10/64 and 5/07/75 OR <br />
				<br />
				(C) Served on active duty for more than 180 days and served in the 
				Republic of Vietnam between 2/28/61 and 5/07/75. <br />
				<br />
			</td>
		</tr>
		<tr>
			...
			<td>A veteran in one of the following groups:<br />
				...
				<br />
				(B) Veterans whose service in a campaign or expedition for which 
				a campaign badge has been authorized or an expeditionary medal has 
				been awarded. This includes a number of engagements.
	...
	<div>
		...
		For each applicant where the prospective employer needs us to provide documentation 
		and data related to OFCCP, we request these applicants to provide this data 
		by filling form -OFFCP (Applicant Self- Disclosure Form) along with their 
		application for the job requisition they were solicited or applied for. 
		The data collected for this purpose will be kept confidential and may only 
		be used in accordance of the permissible laws, executive orders and regulations, 
		including those require these information to be summarized and reported 
		to the federal government for civil rights enforcement. When reported data 
	...
	<div style="text-align: center; width: 100%">
		<asp:Button id="buttonSubmit" runat="server" style="font-size: 12pt; font-weight: bold" Text="Submit"></asp:Button>
