...
<head runat="server" prefix="og: http://ogp.me/ns#">
	...
	****************
	...
	<!-- #BeginEditable "head" -->
	<script src="scripts/jquery.callout-min.js" type="text/javascript"></script>
	<!-- #EndEditable -->
	<script type="text/javascript">
	...
	<table cellpadding="0" cellspacing="0" class="maintbl">
		...
		<tr>
			<td class="tdContent">
				...
				<h1>Staffing Redefined!</h1>
				<div>AGreatis&#8480; as the name suggests, strive to be A GREAT partner to our clients in achieving their goals to acquire the best human resources within their industry. Our job is not just to help client&rsquo;s hire employees to fill a job position, but finding a finding the A GREAT employee for that job.</div>
				<div>We partner with our client&rsquo;s Human Resources professionals and hiring managers in their pursuit to find the best talents which they otherwise would not have access to thru conventional means and standard recruitment practices. We provide them the access to valuable talents by deploying proven hiring and search tools and strategies to find and engage potential candidates who are passively looking or only looking for specific job opportunities within their preferred organizations. Conventional wisdom is that good candidates are already gainfully employed!</div>
				<div>We provide our clients the pivotal communiqu&eacute; to attract talent and manage the hiring process. We become the pivotal link between our clients and their potential human resource they need to hire.</div>
				<div>To find these talents companies need a true and enduring partner to deliver the results and gain a competitive advantage in the new generation of knowledge based global economy.<br />
				</div>
					<!-- #EndEditable -->
				</form>
			</td>
...
<script type="text/javascript">
	$(window).load(function()
	{
		var _msg = '1: of, relating to, or constituting a pivot <br>2: vitally important : critical <br>&#8212; piv&#8226;ot&#8226;al&#8226;ly\-t&#601;l-&#275;\ adverb';
		$("#spanPivotal").callout({ show:false,position:'right',align:'left',pointer:'left',msg:_msg }); 
	});
	$('#spanPivotal').mouseenter(function() 
	{
		$(this).callout("show");
	}).mouseleave(function()
	{
