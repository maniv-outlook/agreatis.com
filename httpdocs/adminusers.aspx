	...
	<table cellpadding="0" cellspacing="0" class="maintbl">
		...
		<tr>
			<td class="tdContent">
				...
				<asp:HyperLink runat="server" NavigateUrl="adminuser.aspx?id=0">Add new User</asp:HyperLink>
				<div>
					<asp:GridView ID="grigUser" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
						DataSourceID="sqlUser" EmptyDataText="No Users" ShowHeaderWhenEmpty="True" Width="100%">
						<Columns>
							<asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="adminuser.aspx?id={0}"
								DataTextField="EmailId" HeaderText="Email Id" />
					...
					<asp:SqlDataSource ID="sqlUser" runat="server" ConnectionString="<%$AppSettings:ConnStr %>"
						DeleteCommand="DeleteUser" DeleteCommandType="StoredProcedure" ProviderName="System.Data.SqlClient"
