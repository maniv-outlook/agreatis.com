	...
	<table cellpadding="0" cellspacing="0" class="maintbl">
		...
		<tr>
			<td class="tdContent">
				...
				<div>
					Apply Online
					<asp:Label id="labelUser" runat="server" AssociatedControlID="textUser" Text="User Name:"></asp:Label>
					<asp:TextBox id="textUser" runat="server"></asp:TextBox>
					<asp:Label id="labelPass" runat="server" AssociatedControlID="textPass" Text="Password:"></asp:Label>
					<asp:TextBox id="textPass" runat="server" TextMode="Password"></asp:TextBox>
					<asp:Button id="buttonSubmit" runat="server" Text="Log In"></asp:Button>
					<asp:HyperLink runat="server" id="linkRegister" NavigateUrl="~/register.aspx">Register</asp:HyperLink>
				</div>
					<!-- #EndEditable -->
				</form>
			</td>
