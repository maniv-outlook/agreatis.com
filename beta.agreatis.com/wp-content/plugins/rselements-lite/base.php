...
final class Rsaddon_Elementor_lite_Extension {
	...
	public function init_widgets() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_Heading_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_Heading_dual_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_Animated_Heading_Widget());

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_Team_Grid_Widget() );
		
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Portfolio_lite_Grid_Widget() );		

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_RSCounter_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_RSservices_Grid_Widget() );
		
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_RSvideo_Widget() );
		
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_Pricing_Table_Widget() );
		
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_lite_Button_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_lite_Logo_Showcase_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_lite_CTA_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_lite_Testimonial_Grid_Widget() );
		
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_lite_Flip_Box_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_lite_Tab_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_RSIcon_Box_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_Blog_Grid_Widget() );
		
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_RSnumber_Grid_Widget() );		

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_RSCF7_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_progress_Widget() );
		
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_RScontactbox_Grid_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_RSTooltip_Box_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_RSStatic_Product_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_Faq_Widget() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_lite_Image_Showcase_Widget() );
		
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_lite_Business_Hour_Widget() );
