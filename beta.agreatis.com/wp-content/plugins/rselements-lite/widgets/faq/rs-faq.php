...
class Rsaddon_Elementor_lite_Faq_Widget extends \Elementor\Widget_Base {
...
protected function _register_controls() {
       ...
       $this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Title/Content', 'rsaddon' ),
		...
		echo '<div class="rs-faq-main">';
			...
			foreach ( $settings['faqs'] as $index => $item ) :				
				...
				if(!empty($item['faq_content'])): ?>
					<div class="rs-faq-content"> <?php echo esc_html( $item['faq_content']);?></div>
				<?php endif;
