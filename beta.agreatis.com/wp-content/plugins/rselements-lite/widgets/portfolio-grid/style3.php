		...
		<div class="portfolio-item content-overlay">
			<?php if(has_post_thumbnail()): ?>
                <div class="portfolio-img">
                	<a class="pointer-events" href="#rs_port3_<?php echo esc_attr($x);?>" data-effect="mfp-zoom-in"><?php  the_post_thumbnail($settings['thumbnail_size']);?></a>
                </div>
            <?php endif;?>
                ...
                <div class="vertical-middle">
                    <div class="vertical-middle-cell">
                    	<?php if(get_the_title()):?>
                    		<h4 class="p-title"><a class="pointer-events" href="#rs_port3_<?php echo esc_attr($x);?>" data-effect="mfp-zoom-in"><?php the_title();?></a></h4>
                    	<?php endif;?>
