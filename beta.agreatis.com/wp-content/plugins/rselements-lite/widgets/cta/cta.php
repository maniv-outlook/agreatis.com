...
class Rsaddon_lite_CTA_Widget extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => rsaddon_lite_get_icons(),				
		...
		$this->add_responsive_control(
			'cta_full_width',
			[
		        'label' => __( 'Full Width ', 'rsaddon' ),
		        'type'    => Controls_Manager::SELECT,
		        'default' => 'inline-flex',
		        'options' => [
		            'inline-block' => __( 'Enable', 'rsaddon' ),
                    'inline-flex' => __( 'Disable', 'rsaddon' ),
		        ],
                'selectors' => [
		...
		$this->add_responsive_control(
            ...
            [
		        ...
		        'default' => '',
		        'options' => [
		            'center' => __( 'Center', 'rsaddon' ),
                    'start' => __( 'Start', 'rsaddon' ),
                    'baseline' => __( 'Baseline', 'rsaddon' ),
                    'unset' => __( 'Unset
                    	', 'rsaddon' ),
		        ],
                'selectors' => [
		...
		$this->add_control(
            'desc_style',
            [
                'label' => __( 'Description Style', 'rsaddon' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
		...
		$this->add_control(
		    'btn_icon_spacing',
		    [
		        'label' => __( 'Icon Translate X', 'rsaddon' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 10
		        ],
