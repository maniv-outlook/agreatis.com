...
class Rsaddon_Elementor_lite_Blog_Grid_Widget extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		//$category_dropdown = array( '0' => esc_html__('Select Category', 'rsaddon' ) );	
									...
									<div class="blog-content">
										...
										<?php if(($settings['blog_meta_show_hide'] == 'yes') ){ ?>
											...
											<div class="blog-meta">
												...
												<span class="date"><i class="fa fa-calendar"></i> <?php echo esc_html($full_date);?></span>
												<?php } ?>
